    ...
    $(function () {
        ...
        let dataSource = new kendo.data.DataSource({
            transport: {
                ...
                create: function (options) {
                    location.href = "admin.php?page=add-activity";
                },
        ...
        var grid = $("#grid").kendoGrid({
            ...
            pageable: {
                ...
                messages: {
                    empty: "No activities",
                    itemsPerPage: "Activities per page",
                    previous: "Previous",
                    next: "Next",
                    first: "First",
                    last: "Last"
            ...
            columns: [{
                ...
                command: [{
                    ...
                    click: function (e) {
                        ...
                        location.href = "admin.php?page=add-activity&id=" + dataItem.id;
                    }
                }, {
                    name: "copy",
                    ...
                    click: function (e) {
                        let dataItem = $("#grid").data("kendoGrid").dataSource.getByUid($(e.target).closest("tr").attr("data-uid"));
                        location.href = "admin.php?page=add-activity&copyid=" + dataItem.id;
                    }
                }, {
                    name: "remove",
                    text: "Delete",
