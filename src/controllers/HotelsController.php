...
class HotelsController extends MasterController
{
    ...
    public function ajax()
    {
        if (isset($_POST['type'])) {
            ...
            switch ($action) {
                ...
                case "deleteHotel":
                    if (isset($_POST['id'])) {
                        echo $this->deleteHotel($_POST['id']);
                    }
                    break;
                default:
                    parent::ajax();
     ...
     * @return Hotel|false|string|null
     */
    public function getHotelById($id, bool $json_encode = false)
    {
     ...
     */
    public function getHotels(bool $json_encode = false)
    {
    ...
    public function updateGridHotel()
    {
        if (isset($_POST['hotel'])) {
            ...
            $hotel = Hotel::withRow($hotel_data);
